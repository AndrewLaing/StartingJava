...
public class Challenge10
{
    ...
    {
        float profit = getProfit( getNS(), getPP(), getPC(), getSP(), getSC() );
        ...
        if(profit==0F)
        {
            message = "You made nothing and lost nothing on this deal.\n" +
                    "The total profits were £" + pounds.format(profit);
        }
        else if(profit<0)
        {
            message = "You made a bad investment.\n" +
                    "Your total losses on this deal were £" + pounds.format( Math.abs(profit) );
        }
        else
        {
            message = "You made a good investment.\n" +
                    "Your total profit on this deal was £" + pounds.format( profit );
        }
