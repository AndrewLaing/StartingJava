 ...
 */
public class OrderedStringListIterator implements Iterator<String>
{
    private OrderedStringListType list;    // the list to iterate over
     ...
     */
    public OrderedStringListIterator(OrderedStringListType aList)
    {
