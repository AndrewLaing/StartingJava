 ...
 * Date:   01/02/2017.
 */
public class OrderedStringSetType implements StringSet,
                                              Iterable
{
     ...
     */
    public OrderedStringSetType(int capacity)
    {
        if (capacity < 1)
    ...
    {
        return new OrderedStringSetIterator(this);
    }
