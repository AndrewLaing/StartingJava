...
public class Essay extends GradedActivity
{
    ...
    public Essay(Essay object2)
    {
        super();
        this.grammar = object2.getGrammar();
        this.spelling = object2.getSpelling();
        this.correctLength = object2.getCorrectLength();
        this.content = object2.getContent();
        setScore(object2.getScore());
    }
